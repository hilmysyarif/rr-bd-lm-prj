...
Public Class cls_tblSettings
    ...
    Sub New()
        ...
        Try
            vOtherSettings = JsonConvert.DeserializeObject(Of OtherSetiings_S)(SelectScalar(Fields.OtherSettings).ToString)
        Catch ex As Exception
            Try
                vOtherSettings = JsonConvert.DeserializeObject(Of OtherSetiings_S)("{""EscortServices"":[""180"",""240"",""120"",""300""]}")
