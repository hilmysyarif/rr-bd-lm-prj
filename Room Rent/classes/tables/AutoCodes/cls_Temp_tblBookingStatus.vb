...
Imports System.IO
Public Class cls_Temp_tblBookingStatus
Inherits Database_Table_code_class_tblBookingStatus
    ...
    Function NewId(Status_ As String) As Integer
        Dim isDisposableItem As Boolean = False
        Dim objConn As clsConnection = Nothing
        ...
        Dim comSelectDistinct As New SqlCommand("Select max(NewId) from tblBookingStatus where [Status]='" & Status_.ToString & "'")
        Try
            _NewId = comSelectDistinct.ExecuteScalar + 1
        Catch ex As Exception
        End Try
