...
Public Class cls_tblSettings2
    ...
    Private ReadOnly Property tblSettings2_insert
        Get
...
[ItemSl]=@ItemSl
    ...
    Private ReadOnly Property tblSettings2_Delete_By_ItemSl
        Get
            Return <tblSettings2_Delete><![CDATA[

DELETE FROM
[tblSettings2] 
WHERE
[ItemSl]=@ItemSl
                    ]]></tblSettings2_Delete>.Value
        End Get
    End Property
...
SELECT MAX([ItemSl]) FROM [tblSettings2] WHERE 1=1
        ...
        End Get
    End Property
    Private ReadOnly Property tblSettings2_Select
        Get
...
WHERE 1=1
    ...
    Function Update_field(ByVal _fieldName As FieldName, ByVal value As Object, _
        ...
        Dim comUpdate As New SqlCommand("Update [tblSettings2] Set [" & _fieldName.ToString & "]=@" & _fieldName.ToString & " WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectString.Trim.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
    ...
    Function Delete_By_ItemSl(ByRef ItemSl As Integer, _
        ...
        Dim comDelete As New SqlCommand(tblSettings2_Delete_By_ItemSl, _conn)
        If Not _transac Is Nothing Then
            comDelete.Transaction = _transac
        End If
    ...
    Function Selection_One_Row(ByVal ItemSl As Integer, Optional ByVal _conn As SqlConnection = Nothing, Optional ByVal _transac As SqlTransaction = Nothing) As Fields
        ...
        If Not _transac Is Nothing Then
            comSelection.Transaction = _transac
        End If
        comSelection.CommandText = tblSettings2_Select & " AND [ItemSl]=@ItemSl"
    ...
    Function SelectScalar(ByVal _fieldName As FieldName, _
        ...
        Dim comSelectScalar As New SqlCommand("SELECT TOP 1 " & _fieldName.ToString & "  from [tblSettings2] WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectString.Trim.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
    ...
    Function SelectDistinct(ByVal _fieldName As FieldName, _
        ...
        Dim comSelectDistinct As New SqlCommand("SELECT DISTINCT " & _fieldName.ToString & "  from [tblSettings2] WHERE 1=1 " & IIf(_selectString <> "", IIf(_selectString.Trim.StartsWith("AND"), _selectString, " AND " & _selectString), ""), _conn)
        If Not _transac Is Nothing Then
