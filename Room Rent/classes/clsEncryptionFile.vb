...
Public Class clsEncryptionFile
    ...
    Public Function Encrypt(ByRef ms As MemoryStream) As MemoryStream
    ...
    Public Function Decrypt(ByVal cipherTextBytes As Byte()) As Byte()
        ...
        'Dim cipherTextBytes As Byte()
        'cipherTextBytes = cipherText.GetBuffer
        ...
        cryptoStream1 = New CryptoStream(ms, _
                                        decryptor, _
                                        CryptoStreamMode.Write)
        ' Start encrypting.
        cryptoStream1.Write(cipherTextBytes, 0, cipherTextBytes.Length)
        cryptoStream1.FlushFinalBlock()

        Decrypt = ms.GetBuffer
    End Function
