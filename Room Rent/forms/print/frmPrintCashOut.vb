...
Public Class frmPrintCashOut
    ...
    Function SetValues() As Boolean
        ...
        Try
            ...
            height_p = heightCommon
            printItems.Add(New PrintItem("CASH OUT".PadRight(16, ". ") & ": " & (currency1 + amount1.ToString("0.00")).PadLeft(8), New Point(20, topAdd), New Point(width_p - 40, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Near}, BrushColor))
            topAdd += height_p - 3
