...
Public Class frmPrintSuspension
    ...
    Dim SuspendedBookingID_ As Integer = 0
    ...
    Function SetValues() As Boolean
        ...
        Try
            ...
            height_p = heightCommon
            printItems.Add(New PrintItem("BOOKING/TICKET NO." & ": " & SuspendedBookingID_, New Point(20, topAdd), New Point(width_p - 40, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Near}, BrushColor))
            topAdd += height_p - 3
            ...
            height_p = heightCommon
            printItems.Add(New PrintItem("SUSPENDED", New Point(20, topAdd), New Point(width_p - 40, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Center, .LineAlignment = StringAlignment.Near}, BrushColor))
            topAdd += height_p - 3
    ...
    Public Sub Print(ByVal CashMemoNumber As String, _
                             ...
                             ByVal ServiceType As String, SuspendedBookingID As Integer)
        ...
        Try
            ...
            SuspendedBookingID_ = SuspendedBookingID
            SetValues()
