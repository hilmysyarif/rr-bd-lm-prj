   ...
   Private oStringFormat As StringFormat
    ...
    Function SetValues() As Boolean
        ...
        Try
            ...
            'Dim CompanyName As String = "BIDYUT SOFTWARES"
            'Dim CompanyAddress As String = "AGARTALA, INDIA"
            'Dim CompanyPh As String = "+919436125037"
            'Dim FooterText As String = "ALL RIGHTS ARE RESERVED."
            ...
            If type1 = memotype.BOTH Or type1 = memotype.BOOKING Then
                height_p = heightCommon
            ...
            If type1 = memotype.BOTH Or type1 = memotype.INSTANT Then
                height_p = heightCommon
                printItems.Add(New PrintItem("DOOR".PadRight(16, ". ") & ": " & door1, New Point(20, topAdd), New Point(width_p - 40, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Near}, BrushColor))
                topAdd += height_p - 3

                height_p = heightCommon
                printItems.Add(New PrintItem("DOOR CHARGE".PadRight(16, ". ") & ": " & (currency1 + doorch1.ToString("0.00")).PadLeft(8), New Point(20, topAdd), New Point(width_p - 40, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Near}, BrushColor))
                topAdd += height_p - 3
            End If
            ...
            If type1 = memotype.BOTH Or type1 = memotype.BOOKING Then
                height_p = heightCommon
                printItems.Add(New PrintItem("CASH OUT".PadRight(16, ". ") & ": " & (currency1 + cashout1.ToString("0.00")).PadLeft(8), New Point(20, topAdd), New Point(width_p - 40, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Near}, BrushColor))
                topAdd += height_p - 3
            End If
