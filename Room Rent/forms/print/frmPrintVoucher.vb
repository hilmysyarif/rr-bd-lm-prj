...
Public Class frmPrintVoucher
    ...
    Function SetValues() As Boolean
        ...
        Try
            ...
            height_p = heightCommon
            printItems.Add(New PrintItem("VOUCHER NO." & ": " & TicketNo1, New Point(20, topAdd), New Point(width_p - 40, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Near}, BrushColor))
            topAdd += height_p - 3
            ...
            height_p = heightCommon
            printItems.Add(New PrintItem("REFERENCE NO.".PadRight(16, ". ") & ": " & ref1, New Point(20, topAdd), New Point(width_p - 40, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Near}, BrushColor))
            topAdd += height_p - 3
            ...
            If card1 > 0 Then
                height_p = heightCommon
                printItems.Add(New PrintItem("CARD PAYMENT".PadRight(16, ". ") & ": " & (currency1 + (card1 + surcharge1).ToString("0.00")).PadLeft(8), New Point(20, topAdd), New Point(width_p - 40, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Near}, BrushColor))
                topAdd += height_p - 3
            ...
            height_p = heightCommon
            printItems.Add(New PrintItem("AMOUNT PAYABLE".PadRight(16, ". ") & ": " & (currency1 + (cash1 + card1 + surcharge1).ToString("0.00")).PadLeft(8), New Point(20, topAdd), New Point(width_p - 40, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Near, .LineAlignment = StringAlignment.Near}, BrushColor))
            topAdd += height_p - 3
            ...
            height_p = 30
            printItems.Add(New PrintItem("Authorised Signatory", New Point(0, topAdd - 5), New Point(width_p, height_p), MainFont, New StringFormat() With {.Alignment = StringAlignment.Far, .LineAlignment = StringAlignment.Far}, BrushColor))
            topAdd += height_p
