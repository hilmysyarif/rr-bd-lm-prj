Public Class frmLockerReport
    Sub New()
        ...
        End If
    End Sub
    Dim objBill As New cls_Temp_tblLockerBooking
    ...
    Sub ShowReport()
        Try
            ...
            dgReport.DataSource = objBill.Selection(cls_Temp_tblLockerBooking.SelectionType.Report, " [BookingDate] between @d1 and @d2", pp)
