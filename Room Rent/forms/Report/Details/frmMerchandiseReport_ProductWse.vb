Public Class frmMerchandiseReport_ProductWse
    Sub New()
    ...
    Sub ShowReport()
        Try
            ...
            dgReport.DataSource = objBill.Selection(cls_Temp_tblBillItems.SelectionType.Report, "a.[BillDate] between @d1 and @d2", pp)
