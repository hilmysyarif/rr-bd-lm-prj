Public Class frmSpReport
    Sub New()
        ...
        End If
    End Sub
    Dim objBill As New cls_Temp_tblBookingPayments
    ...
    Sub ShowReport()
        Try
            ...
            dgReport.DataSource = objBill.Selection(cls_Temp_tblBookingPayments.SelectionType.REPORT_SP_Amounts, "a.[CreatedDate] between @d1 and @d2", pp)
