Public Class frmAmenitiesReport
    Sub New()
        ...
        End If
        Text = "Amenities Report"
    End Sub
    Dim objBill As New cls_Temp_tblDocketMemo
    ...
    Sub ShowReport()
        Try
            ...
            dgReport.DataSource = objBill.Selection(cls_Temp_tblDocketMemo.SelectionType.Cashout, "a.[MemoDate] between @d1 and @d2", pp)
