Public Class frmMembershipReport
    Sub New()
    ...
    Sub ShowReport()
        Try
            ...
            Dim objBill As New cls_Temp_tblMembers
            dgReport.DataSource = objBill.Selection(cls_Temp_tblMembers.SelectionType.Report, "a.[CreatedDate] between @d1 and @d2", pp)
