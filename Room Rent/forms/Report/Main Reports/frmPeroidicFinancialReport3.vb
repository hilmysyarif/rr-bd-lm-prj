Public Class frmPeroidicFinancialReport3
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnReport.Click
        ...
        PageStr += ("").PadLeft(160, "-")
        PageStr += vbNewLine
        PageStr += "DOOR Subtotal".PadRight(25) & _
            dtDoorCharge.Rows.Count.ToString.PadRight(5) & _
            "".PadRight(8) & _
            "".PadRight(12) & _
            "".PadRight(10) & _
            "".PadRight(15) & _
            "".PadLeft(8) & "  " & _
            Val(TotalField(dtDoorCharge, "CASH")).ToString("0.00").PadLeft(8) & "  " & _
            (TotalField(dtDoorCharge, "CARD") + TotalField(dtDoorCharge, "Surcharge_Amt")).ToString("0.00").PadLeft(8) & "  " & _
            (TotalField(dtDoorCharge, "GST")).ToString("0.00").PadLeft(8) & "  " & _
            "".PadLeft(3) & " " & _
            ""
