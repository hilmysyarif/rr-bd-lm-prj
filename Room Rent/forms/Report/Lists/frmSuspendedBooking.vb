Public Class frmSuspendedBooking
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        Try
            ...
            DataGridView1.DataSource = objBooking.Selection(cls_Temp_tblBookings.SelectionType.REPORT, "((a.[Status] like 'Suspended%') or BookingID in (Select BookingID From tblBookingStatus Where Status='SUSPEND')) and BookingDate Between @d1 and @d2 Order by BookingDate", ppp)
    ...
    Private Sub Button1_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles Button1.Click
        frmSuspensions.Show()
        frmSuspensions.Activate()
    End Sub

    Private Sub frmSuspendedBooking_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
