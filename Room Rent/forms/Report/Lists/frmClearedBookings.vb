Public Class frmClearedBookings
    ...
    Private Sub btnShow_Click(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles btnShow.Click
        Try
            ...
            DataGridView1.DataSource = objBooking.Selection(cls_Temp_tblBookings.SelectionType.REPORT, "((a.[Status] like 'CLEARED%') or BookingID in (Select BookingID From tblBookingStatus Where Status='CLEAR')) and BookingDate Between @d1 and @d2 Order by BookingDate", ppp)
    ...
    Private Sub frmClearedBookings_Load(ByVal sender As System.Object, ByVal e As System.EventArgs) Handles MyBase.Load
